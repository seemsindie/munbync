...
# Default target
all: $(LIBRARY) $(EXAMPLE) $(FEED_TEST) $(CHARSET_EXAMPLE) $(CODEPAGE_TABLE_EXAMPLE) $(TEXT_FORMATTING_EXAMPLE) $(BARCODE_EXAMPLE) $(COMPREHENSIVE_BARCODE_EXAMPLE) $(TAB_EXAMPLE) $(RASTER_IMAGE_EXAMPLE) $(PNG_RASTER_EXAMPLE)
...
library: $(LIBRARY)
shared: $(SHARED_LIB)
examples: $(EXAMPLE) $(FEED_TEST) $(CHARSET_EXAMPLE) $(CODEPAGE_TABLE_EXAMPLE) $(TEXT_FORMATTING_EXAMPLE) $(BARCODE_EXAMPLE) $(COMPREHENSIVE_BARCODE_EXAMPLE) $(TAB_EXAMPLE) $(RASTER_IMAGE_EXAMPLE) $(PNG_RASTER_EXAMPLE)
