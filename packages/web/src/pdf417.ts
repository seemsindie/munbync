...
export interface Pdf417Options {
  /** 0 = automatic; otherwise 1..30. */
  columns?: number;
  /** Error-correction level 0..8; default 2. */
  ecLevel?: number;
  /** Horizontal dots per module, 1..8; default 2. */
  moduleSize?: number;
  /** Active printable width, default 512 dots to fit both 512/576-dot units. */
  maxWidth?: number;
}
...
export function encodePdf417(data: string | Uint8Array, options: Pdf417Options = {}): RasterImage {
